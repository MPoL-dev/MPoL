...
# Instead, we suggest an approach where we break the UV plane into radial ($q=\sqrt{u^2 + v^2}$) and azimuthal ($\phi$) cells . There are of course, no limits on how you choose to cross-validate your datasets, and there are most likely other methods that will work well for other types of datasets.
